...
//  TRProject
//
//  Created by tarena11 on 16/7/30.
...
-(void)configScrollView{
    ...
    for (int i = 0; i < 7; i++) {
        ...
        if (i == 6) {
            ...
            [btn addTarget:self action:@selector(GoWowVC:) forControlEvents:UIControlEventTouchUpInside];
...
-(void)GoWowVC:(UIButton *)sender{
    WoWController *wowVC = [[WoWController alloc]init];
    self.view.window.rootViewController = wowVC;
}
